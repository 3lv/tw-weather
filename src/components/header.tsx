  ...
  return (
    ...
    >
      <motion.div 
        ...
        style={{ opacity, scale }}
      >
        <div className={`flex h-16 items-center ${isScrolled ? 'justify-between' : ''}`}>
          {/* Logo Section */}
          ...
          <div className={`flex flex-1 items-center ${isScrolled ? 'justify-end' : 'justify-end'} gap-4`}>
            <Button
              variant="ghost"
              size="icon"
              className="relative"
...
F' : '
                    ...
                    <span className="text-sm text-muted-foreground">{tempUnit}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Switch
                    ...
                    <span className="text-sm text-muted-foreground">{tempPrecision}</span>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
